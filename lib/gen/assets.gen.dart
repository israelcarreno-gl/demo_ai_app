...
class $AssetsEnvGen {
  ...
  /// File path: assets/env/.env.int
  String get aEnvInt => 'assets/env/.env.int';

  /// File path: assets/env/.env.prod
  String get aEnvProd => 'assets/env/.env.prod';

  /// List of all assets
  List<String> get values => [aEnvDev, aEnvInt, aEnvProd];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/flutterImage.png
  AssetGenImage get flutterImage =>
      const AssetGenImage('assets/images/flutterImage.png');
